<template>
  <div class="excel-import">
    ...
    <div
      ...
      class="px-3 py-2 cursor-pointer flex items-center border-2 border-dashed d-theme-border-grey-light d-theme-dark-bg text-xl"
    >
      <feather-icon
        ...
        class="block"
      />
      <span class="karla-bold text-primary ml-2">{{$t("add excel file")}}</span>
      <span class="karla ml-2" @click.stop="$refs.fileInput.click()">{{$t("or drop file here")}}</span>
