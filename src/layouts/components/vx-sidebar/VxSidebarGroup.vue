  ...
  >
    <div @click="clickGroup" class="group-header w-full">
      <span class="flex items-center w-full">
        ...
        >{{ $t(group.i18n) || group.name | capitalize }}</span>
        <vs-chip
          class="ml-auto mr-4"
      ...
      <feather-icon
        ...
        v-show="!sidebarItemsMin"
      />
      <span class="vs-sidebar--tooltip">{{ $t(group.i18n) || group.name | capitalize }}</span>
    </div>
    <ul ref="items" :style="styleItems" class="vs-sidebar-group-items">
      <li v-for="(groupItem, index) in group.submenu" :key="index">
        ...
        />
        <vx-sidebar-item
          :isDisabled="sidebarDisabled(groupItem)"
          ...
          v-else
        >
          <span class="truncate">{{ $t(groupItem.i18n) || groupItem.name | capitalize }}</span>
          <vs-chip
            class="ml-auto"
