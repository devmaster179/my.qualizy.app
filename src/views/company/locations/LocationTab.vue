  ...
  <div>
          ...
          <div class="sm:flex items-start">
            <div class="image-section relative" @click="launchFilePicker">
              ...
              <input
                ...
                name="userPhoto"
                @change="
                  onUserPhotoChange($event.target.name, $event.target.files)
                "
                style="display: none"
              />
            </div>
            <div
              class="company-details ml-3 flex items-start justify-between w-full"
            >
              <div>
                <p class="karla-bold text-2xl color-my-black">
                  {{ company.bussiness }}
                </p>
    ...
    <div class="location-section mt-base">
      <div class="flex items-center justify-between mb-4">
        <p class="page-title karla-bold text-2xl color-my-black">
        ...
        <div class="flex items-center">
          <vs-input
            ...
            icon-no-border
          />
          <vs-button class="kalar ml-4" @click="locationAdd"
            >+ {{ $t("add location") }}</vs-button
          >
        </div>
      </div>
                    ...
                    <div class="vx-row w-full">
                      ...
                      <div class="vx-col w-1/2">
                        <div class="flex items-center">
                          ...
                          <span class="karla ml-1">{{
                            region.address.fAddress
                          }}</span>
                        </div>
                      </div>
    ...
    >
      ...
      <div class="con-exemple-prompt">
        ...
        />
        <span class="text-danger text-sm ml-2">{{
    ...
    >
      <div class="delete-content">
        ...
        <p class="karla-bold text-2xl color-my-black text-center pt-base">
          {{ $t("you are about to delete location") }}
        </p>
        <p class="karla-bold text-sm text-center mt-4">
          {{ $t("this will delete your") }} &#10077;{{ locationName }}&#10078;
          {{ $t("location") }}
        </p>
