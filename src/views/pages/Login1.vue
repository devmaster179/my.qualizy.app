            ...
            <div class="vx-col sm:w-full md:w-full lg:w-1/2 d-theme-dark-bg">
              <div class="sm:p-8 p-4">
                <div class="vx-card__title sm:mb-8">
                  <h4 class="mb-4">{{$t("login") | capitalize}}</h4>
                  <p>{{$t("welcome to back, please login your account.")}}</p>
                </div>
                <vs-input
                  ...
                  :placeholder="$t('email')"
                  v-model="email"
                  class="w-full mt-1 no-icon-border"
                />
                ...
                <vs-input
                  ...
                  v-model="password"
                  class="w-full my-2 sm:mt-6 no-icon-border"
                />
                ...
                <vs-button type="border" @click="registerUser">{{$t("sign up")}}</vs-button>
                <vs-button
                  class="float-right"
                  ref="loginBtn"
                ...
                <vs-divider class="my-1">{{$t("or")}}</vs-divider>

                <div class="social-login flex flex-wrap justify-between">
                  <div class="social-login-buttons flex flex-wrap items-center sm:mt-4">
                    <!-- facebook -->
                    <div
